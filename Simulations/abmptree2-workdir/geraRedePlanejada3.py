...
print "SN.node[1]."+"yCoor = "+str(-y+42)
...
for i in range(0, 12):
    ...
    print "SN.node["+str(i+5)+"]."+"yCoor = "+str(random.uniform(-x+65, -y+65))
...
for i in range(0, 12):
    ...
    print "SN.node["+str(i+29)+"]."+"yCoor = "+str(random.uniform(x-35, y-35))
    print "SN.node["+str(29+i)+"]."+"zCoor = 2"

for i in range(0, 12):
    print "SN.node["+str(i+41)+"]."+"xCoor = "+str(random.uniform(x-55, y-55))
    print "SN.node["+str(i+41)+"]."+"yCoor = "+str(random.uniform(-x+70, -y+70))
