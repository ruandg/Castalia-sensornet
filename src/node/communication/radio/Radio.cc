...
{
	//trace() << "Diego - radioCmd->getRadioControlCommandKind: " << radioCmd->getRadioControlCommandKind();
	switch (radioCmd->getRadioControlCommandKind()) {
		 ...
		 */
		case SET_STATE:{
		//	trace() << "SET_STATE - controle do radio";
		 ...
		 */
		case SET_MODE:{
		//	trace() << "SET_MODE - controle do radio";
		...
		case SET_TX_OUTPUT:{
		//	trace() << "SET_TX_OUTPUT - controle do radio";
		...
		//	trace() << "SET_SLEEP_LEVEL - controle do radio";
		...
		case SET_CARRIER_FREQ:{
			//trace() << "SET_CARRIER_FREQ - controle do radio";
		...
		case SET_CCA_THRESHOLD:{
			//trace() << "SET_CCA_THRESHOLD - controle do radio";
		...
		//	trace() << "SET_CS_INTERRUPT_ON - controle do radio";
		...
		//	trace() << "SET_CS_INTERRUPT_OFF - controle do radio";
		...
		case SET_ENCODING:{
			//trace() << "SET_ENCODING - controle do radio";
			encoding = parseEncodingType(radioCmd->getName());
			break;
		}
		case WC_UPD:{
			WirelessChannelSignalBegin *begin =
					new WirelessChannelSignalBegin("WC_Update", WC_UPDATE);
