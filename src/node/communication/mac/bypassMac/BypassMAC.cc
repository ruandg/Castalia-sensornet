 ...
 */
void BypassMAC::fromNetworkLayer(DataPacket * data_packet, int destination) {

	if (data_packet->getDataPacket()[0] == 99) {
		toRadioLayer(createRadioCommand(SET_CARRIER_FREQ, data_packet->getDataPacket()[1]));
		return;
	} 
